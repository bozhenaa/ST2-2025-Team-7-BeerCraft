...
namespace BeerCraftMVC.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "IngredientCharacteristics",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientCharacteristics", x => new { x.IngredientId, x.CharacteristicId });
                    table.ForeignKey(
                        name: "FK_IngredientCharacteristics_Characteristics_CharacteristicId",
                        column: x => x.CharacteristicId,
                        principalTable: "Characteristics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientCharacteristics_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventories", x => new { x.UserId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientCharacteristics_CharacteristicId",
                table: "IngredientCharacteristics",
